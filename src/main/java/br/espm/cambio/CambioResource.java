...
public class CambioResource {
    ...
    @DeleteMapping("/moeda/{id:[a-f0-9]{8}(?:-[a-f0-9]{4}){4}[a-f0-9]{8}}") //dElEtA PoR iD
...
// spring boot endpoint regex -> buscar 
    ...
    public List<Cotacao> findCotacaoBySimbolo(@PathVariable String simbolo){
        List<Cotacao> cotacaoLista = cotacaoService.listCotacao(simbolo);
        cotacaoLista.forEach(c -> c.setId(null));
        return cotacaoLista;
    }
